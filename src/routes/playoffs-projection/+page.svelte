...
/* Legend overlay: separate, plain white text */
.legend-overlay {
  position: absolute;
...
.legend-overlay em { color: #ddd; font-size: 0.65rem; }
</style>

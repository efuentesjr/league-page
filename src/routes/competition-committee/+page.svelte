<script lang="ts">
  ...
  const proposals: Proposal[] = [
    ...
    { id: 6, title: 'Player tags, "No trade back for top 35 players. Re-evaluate and reduce to: OPTION#1: QB's: 16 OPTION#2: RB's: 20 WR's: 25, TE's: 10', owner: 'Commish', status: 'OPEN' },

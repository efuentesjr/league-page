<script lang="ts">
  ...
  const proposals: Proposal[] = [
    ...
    { id: '8', title: 'Offer incentives for Divisional Champs. OPTION#1: $25 payout (would require league fee increase). OPTION#2: A bye week for the 1st round of playoffs (would require reducing playoff teams to 6). OPTION#3: 25% of Max yearly FAAB, rounded to the nearest hole number. OPTION#4: NO.', owner: 'Jordan Fristoe / Nick Bowens', status: 'NEW' },
    { id: '9', title: 'Payout 3rd place runner-up. OPTION#1: $25. OPTION#2: $35. OPTION#3: NO.', owner: 'Commish', status: 'NEW' },
    { id: '10', title: 'Raise dues ($75 → $85 or more) 2/3 vote needed to raise fees or 11 owners. Commish to provide rationale. OPTION#1: $85. OPTION#2: $100. OPTION#3: NO.', owner: 'Commish', notes: 'Section 7.3', status: 'OPEN' },

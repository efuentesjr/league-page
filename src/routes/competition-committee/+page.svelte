<script lang="ts">
  ...
  const proposals: Proposal[] = [
    ...
    { id: '1-B', title: 'Allow punt return yards scoring (re-vote) OPTION#1: No. OPTION#2: Yes, the same as RB/WR, 10yrd=1pts (100yrd=10pts). OPTION#3: Yes, but less than RB/WR, 15yrd=1pts (150yrds=1pts).', owner: 'John Diaz-Decaro', notes: 'Section 4.1', status: 'REVOTE' },

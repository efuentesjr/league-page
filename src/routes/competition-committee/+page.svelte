<script lang="ts">
  ...
  const proposals: Proposal[] = [
    ...
    { id: '10', title: 'Raise dues ($75 → $85 or more) 2/3 vote needed to raise fees or 11 owners. Commish to provide rationale. OPTION#1: $85. OPTION#2: $100.', owner: 'Commish', notes: 'Section 7.3', status: 'OPEN' },

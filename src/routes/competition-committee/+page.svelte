<script lang="ts">
  ...
  const proposals: Proposal[] = [
    ...
    { id: '9', title: 'Offer incentives for Divisional Champs. OPTION#1: $25 payout (would require league fee increase). OPTION#2: A bye week for the 1st round of playoffs (would require reducing playoff teams to 6). OPTION#3: 25% of Max yearly FAAB, rounded to the nearest hole number. ', owner: 'Jordan Fristoe / Nick Bowens', status: 'NEW' },

<script lang="ts">
  ...
  const proposals: Proposal[] = [
    ...
    { id: '10', title: 'When trading future picks you will need to pay some additional $$$, in addition to regular fees and those fees will go towards that year's fees. OPTION#1 YES. OPTION#2 NO.', owner: 'John Diaz-DeCaro', status: 'NEW' },
    { id: '11', title: 'Waiver wire player drop restrictions and collusion prevention. OPTION#1: All players over 10 PPG. OPTION#2: All players above 15 PPG. OPTION#3 NO.', owner: 'Commish', status: 'NEW' },

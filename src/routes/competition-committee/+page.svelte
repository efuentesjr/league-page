<script lang="ts">
  ...
  const proposals: Proposal[] = [
    ...
    { id: '10', title: 'When trading future picks you will need to pay some additional $$$, in addition to regular fees and those fees will go towards that years fees. OPTION#1: YES. OPTION#2: NO.', owner: 'John Diaz-DeCaro', status: 'NEW' },

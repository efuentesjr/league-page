<script lang="ts">
  ...
  const proposals: Proposal[] = [
    ...
    { id: '3', title: 'Player tags, "No trade back for top 35 players." Re-evaluate and reduce to OPTION#1: QBs 20. OPTION#2: RBs 20. OPTION#3: WRs 20. OPTION#4: TEs 10.', owner: 'Commish', status: 'REVOTE' },
